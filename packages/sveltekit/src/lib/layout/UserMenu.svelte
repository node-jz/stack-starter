...
{#if $userStore && $userStore.user}
  <div class="relative w-full">
    <button role="button" class="flex items-center gap-3 text-xs font-medium text-slate-500" on:click|stopPropagation={handleShowMenu}>
    ...
    {#if menuVisible}
      <div
        bind:this={menuRef}
        class="absolute -top-12 right-0 z-50 mt-2 w-48 origin-top-right rounded-md bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
        role="menu"
